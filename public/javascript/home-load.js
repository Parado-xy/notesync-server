    ...
    try {
        ...
        if (response.ok) {
            ...
            if (userData) {
                ...
                // SET INSTANCE ID
                const instanceController = new SetInstanceIDs(localStorage);
                instanceController.setInstance(userData.user.firstName, userData.user._id);
...
function insertNoteCard(noteData) {
    ...
    dateElement.textContent = `Created: ${noteData.createdAt ? 
    ...
    deleteButton.addEventListener('click', () => {
        ...
        if (confirm('Are you sure you want to delete this note?')) {
            ...
            try {
                ...
                const noteToRemove = document.querySelector(`[data-note-id="${noteData.id}"]`);
                if (noteToRemove) {
                    noteToRemove.remove();
                }
            } catch (err) {
