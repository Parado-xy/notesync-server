...
function handleTagsChange(event) {
    ...
    const tags = Array.from(document.querySelectorAll('#tagContainer input')).map(input => input.value);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (noteId) {
        ...
        document.getElementById('noteTitleInput').addEventListener('input', handleTitleChange);
        document.getElementById('tagContainer').addEventListener('change', handleTagsChange);
